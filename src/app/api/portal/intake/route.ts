...
import { getPendingPortalIntakePacket } from '@/services/intake-packet.service';
...
export async function GET(_req: NextRequest) {
  try {
    ...
    const packet = await getPendingPortalIntakePacket(client, DEV_PATIENT_ID, DEV_ORG_ID);
