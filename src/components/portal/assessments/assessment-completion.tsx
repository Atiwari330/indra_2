...
export function AssessmentCompletion({ hasNext, onNext, onHome }: AssessmentCompletionProps) {
  return (
    <motion.div
    ...
    >
      ...
      >
        <p className="text-callout text-center" style={{ color: 'var(--color-text-secondary)' }}>
          Your therapist will review your responses and can discuss them at your next session.
        </p>
      </motion.div>
      ...
      >
        {hasNext ? (
          <>
            ...
            >
              Next: Check-in (2 min) &rarr;
            </button>
            <button
              onClick={onHome}
              className="px-6 py-2.5 rounded-full text-callout font-medium transition-colors"
              style={{
