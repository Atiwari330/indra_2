...
export function PhaseError({ run }: PhaseErrorProps) {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center py-12">
      ...
      >
        <AlertTriangle size={36} strokeWidth={1.8} style={{ color: 'var(--color-error)' }} />
      </div>
      ...
      {/* Error message in a glass-subtle box */}
      <div
        className="glass-subtle mb-8 max-w-sm rounded-[var(--radius-md)] px-4 py-3 text-center text-callout"
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={dismiss}
          className="rounded-[var(--radius-md)] px-4 py-3 text-callout font-medium transition-colors"
          style={{
